...
# Ulhpc/sysctl Puppet Module Developments
...
### Directory Layout
       ...
       ULHPC/sysctl/       # Main directory 
           ...
           `-- manifests/
                `-- init.pp      # Main manifests file which defines the ULHPC/sysctl class 
                `-- params.pp    # ULHPC/sysctl module variables 
                `-- mydef.pp     # defines the ULHPC/sysctl::mydef  definition   
